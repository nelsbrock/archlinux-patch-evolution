...
arch=('i686' 'x86_64')
license=('GPL')
depends=('libnotify>=0.4.5' 'gtkhtml>=3.30.1' 'evolution-data-server>=2.30.1' 'gnome-pilot>=2.0.17' 'gstreamer0.10>=0.10.28' 'libpst>=0.6.41' 'libytnef>=0.1.5' 'gnome-desktop>=2.30.0' 'libcanberra>=0.23' 'gtkimageview>=1.6.4')
...
sha256sums=('8b946914e53135edf89f9ddb8667d0ca3d76d37d8c622888befd65b2c4d3ce24')
